...
export default function Create({ auth }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (data.access_type === 'direct_download' && !data.digital_file) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header="Créer un Produit Digital">
            <Head title="Créer un Produit Digital" />
                ...
                <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm">
                    <div className="border-b border-slate-100 pb-4 mb-6">
                        <h2 className="text-lg font-bold text-slate-900">
                            Création de la ressource numérique
                        </h2>
                        <p className="text-slate-500 mt-1">
                            Remplissez les détails ci-dessous pour publier votre nouveau produit digital.
                        </p>
                    </div>
                        ...
                        <div className="p-5 bg-slate-50 border border-slate-200 rounded-xl space-y-4">
                            ...
                            {data.access_type === 'drive' ? (
                                ...
                                <div className="space-y-2">
                                    <label className="block text-slate-700 font-bold mb-1">
                                        Fichier Numérique Local (PDF, ZIP, MP4...) <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="file"
                                        required={data.access_type === 'direct_download'}
