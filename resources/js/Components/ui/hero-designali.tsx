...
function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid h-full w-full place-items-center rounded-2xl bg-white p-3 text-gray-900 dark:bg-[#0B0F19] dark:text-white border border-gray-200 dark:border-gray-800",
        className
      )}
    >
      <div
