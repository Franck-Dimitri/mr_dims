    ...
    return (
        <Modal show={show} onClose={onClose} maxWidth="5xl">
            <div className="bg-[#0B0F19] text-white border border-blueprint-bluePrimary/40 dark:border-blueprint-cyan/40 shadow-2xl overflow-hidden font-sans flex flex-col max-h-[90vh] rounded-2xl">
                ...
                {/* View Mode Switcher */}
                <div className="bg-[#070A10] border-b border-gray-800 px-5 py-2 flex items-center justify-between text-xs font-sans">
                    <div className="flex items-center gap-2">
                        <button
                            onClick={() => setViewMode('pdf')}
                            className={`px-3 py-1.5 text-xs font-bold transition-colors flex items-center gap-1.5 rounded-lg ${
                                viewMode === 'pdf'
                ...
                <div className="flex-1 overflow-y-auto bg-[#070A10] p-4 sm:p-6 min-h-[550px] flex justify-center items-center">
                    {viewMode === 'pdf' ? (
                        <div className="w-full h-full min-h-[550px] relative rounded-xl overflow-hidden border border-gray-800 bg-gray-900">
                            <object
                                ...
                                >
                                    <div className="p-8 text-center text-gray-400 font-sans">
                                        ...
                                        <a
                                            href={pdfUrl}
                                            download
                                            className="px-4 py-2 bg-blueprint-cyan text-gray-900 font-bold text-xs rounded-xl"
                                        >
                                            Télécharger le PDF
                                        </a>
                                    </div>
                        ...
                        <div className="w-full flex justify-center max-w-3xl border border-gray-800 bg-white/5 p-2 rounded-2xl shadow-2xl">
                            <img
                                src={imageUrl}
                                alt="CV - Kouongme Mbouom F. Dimitri"
                                className="w-full h-auto max-h-[75vh] object-contain shadow-lg rounded-xl"
                            />
                        </div>
                    )}
                </div>
                ...
                {/* --- FOOTER --- */}
                <div className="bg-[#111827] border-t border-gray-800 px-5 py-3 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-400 font-sans">
